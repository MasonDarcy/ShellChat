...
//
const EMBEDDED_COMMAND_SUCCESS_EVENT_KEY = "EMBEDDED_COMMAND_SUCCESS_EVENT";

//Succesful authentication action
const AUTH_SUCCESS_EVENT_KEY = "AUTH_SUCCESS_EVENT";

const SIGNUP_SUCCESS_EVENT_KEY = "AUTH_SUCCESS_EVENT";
...
const ACCEPTED_FRIEND_REQUEST_EVENT_KEY = "ACCEPTED_FRIEND_REQUEST_EVENT";
...
//Reject friend
const REJECT_FRIEND_REQUEST_EVENT_KEY = " REJECT_FRIEND_REQUEST_EVENT";
...
const REQUEST_LIST_ITEM_EVENT_KEY = "REQUEST_LIST_ITEM_EVENT";

const GUEST_HINT_EVENT_KEY = "GUEST_HINT_EVENT";

const PURE_JSX_EVENT_KEY = "PURE_JSX_EVENT";
/*----------------------------------------------------------------------*/
module.exports = {
  REQUEST_LIST_ITEM_EVENT_KEY,
  GUEST_HINT_EVENT_KEY,
  REJECT_FRIEND_REQUEST_EVENT_KEY,
  ACCEPTED_FRIEND_REQUEST_EVENT_KEY,
  PURE_JSX_EVENT_KEY,
  SIGNUP_SUCCESS_EVENT_KEY,
  EMBEDDED_COMMAND_SUCCESS_EVENT_KEY,
